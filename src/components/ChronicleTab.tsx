...
import { WorldNewsSidebar } from './chronicle/WorldNewsSidebar';
import { 
  Sparkles, 
  Calendar, 
  Award, 
...
interface ChronicleTabProps {
  ...
  onOpenVassals: () => void;
  onOpenSaveLoad?: () => void;
  onAddChronicleEntry?: (entry: ChronicleEntry) => void;
}
...
export const ChronicleTab: React.FC<ChronicleTabProps> = ({
  ...
  return (
    <div className="space-y-4 max-w-4xl mx-auto pb-20">
      ...
      {/* Dual Column Layout: Left = Chronicle Timeline, Right = World News Sidebar */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        
        {/* Left Column: Chronicle Timeline Feed (2 Cols) */}
        <div className="lg:col-span-2 bg-stone-900/95 rounded-2xl p-4 sm:p-6 border border-stone-800 shadow-2xl space-y-4">
          
          {/* Timeline Header & View Switcher */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2 border-b border-stone-800 pb-3">
            <div>
        ...
        {/* Right Column: Grounded World News & Gazettes Sidebar (1 Col) */}
        <div className="lg:col-span-1">
          <WorldNewsSidebar 
            currentYear={currentYear}
            onAddChronicleEntry={onAddChronicleEntry}
          />
        </div>
