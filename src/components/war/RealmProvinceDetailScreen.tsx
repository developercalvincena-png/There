      ...
      <div className="bg-[#FAF7EB] text-[#181512] rounded-2xl border border-stone-400/60 shadow-2xl overflow-hidden">
        ...
        <div>
          ...
          <div className="divide-y divide-stone-200/90">
            ...
            {/* Declare War (Only if not already player-controlled / vassal) */}
            {target.controlPercent === 100 || target.type === 'vassal' ? (
              <div className="px-4 py-3 bg-amber-50/80 border-b border-amber-200/60 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">👑</span>
                  <div>
                    <span className="font-extrabold text-sm text-stone-900 block">
                      Crown Territory / Sovereign Demesne
                    </span>
                    <span className="text-[11px] text-amber-900 font-medium">
                      This domain is already part of your realm.
                    </span>
                  </div>
                </div>
                <span className="text-[10px] font-black uppercase bg-[#D49B28] text-stone-950 px-2 py-0.5 rounded">
                  YOURS
                </span>
              </div>
            ) : (
